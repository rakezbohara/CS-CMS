            ...
            <div class="topic articlethumb">
                <form class="form-horizontal" method="post" action="career" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="email" name="email" class="form-control" id="pwd" placeholder="Enter Email" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="email">Apply for:</label>
                        <div class="col-sm-8">
                            <select class="form-control" name="jobname" id="sel1">
                                <option disabled selected hidden>-----</option>
                                @foreach($career as $careeritem)
                                    <option value ="{{ $careeritem['title'] }}" >{{ $careeritem['title'] }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
